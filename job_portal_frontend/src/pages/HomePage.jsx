        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Browse through thousands of job listings or receive personalized
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            ...
            through Elevate Workforce. Create your account today and unlock a world of
            opportunities.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 pt-8 border-t border-gray-700 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} Elevate Workforce. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
